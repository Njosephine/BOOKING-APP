...
const Banner = () => {
    ...
    return (
        <div className='flex bg-primary rounded-lg  px-6 sm:px-10 md:px-14 lg:px-12 my-20 md:mx-10'>
            ...
            {/* ------- Right Side ------- */}
            <div className='hidden md:block md:w-1/2 lg:w-[240px] relative'>
                <img className='w-full absolute bottom-0 right-0 max-w-md' src={assets.appoint} alt=""   style={{width: '900px', height:'430px'}}/>
            </div>
        </div>
    )
}
