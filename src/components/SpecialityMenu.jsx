...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-[#262626]'>
            ...
            <p className='sm:w-1/3 text-center text-sm'>Effortlessly explore our comprehensive directory of experienced and reliable doctors, schedule your appointment with us.</p>
